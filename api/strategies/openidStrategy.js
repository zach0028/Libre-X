...
/**
 * Factory function to create CustomOpenIDStrategy class
 * @param {typeof OpenIDStrategy} BaseStrategy
 */
function createCustomOpenIDStrategy(BaseStrategy) {
...
async function setupOpenId() {
  try {
    ...
    const CustomOpenIDStrategy = createCustomOpenIDStrategy(OpenIDStrategy);
